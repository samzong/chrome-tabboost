...
export const UI_CONFIG = {
  ...
  iframe: {
    ...
    attributes: {
      loading: "lazy",
      // NOTE: Using both allow-scripts and allow-same-origin together triggers a browser
      // security warning, but this is necessary for accessing iframe content to inject
      // styles (removing body margin/padding). This is an acceptable trade-off for the
      // split-view functionality. The iframe content is isolated in a sandboxed context
      // and only loads user-requested URLs.
  ...
  ratioPresets: [
    {
      ...
      top: 50,
      bottom: 50,
      label: i18n.getMessage("splitViewEqualRatio"),
    },
    {
      left: 70,
      right: 30,
      top: 70,
      bottom: 30,
      label: i18n.getMessage("splitViewLeftLarger"),
    },
    {
      left: 30,
      right: 70,
      top: 30,
      bottom: 70,
      label: i18n.getMessage("splitViewRightLarger"),
    },
  ],
};
